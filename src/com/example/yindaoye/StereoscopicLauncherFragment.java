...
public class StereoscopicLauncherFragment extends LauncherBaseFragment implements OnClickListener
{
	...
	imgView_immediate_experience = (ImageView) rooView
	...
	animationSet.setAnimationListener(new AnimationListener()
	{
		 ...
		 */
		AnimationSet animationSet = new AnimationSet(true);
		animationSet.addAnimation(new ScaleAnimation(ZOOM_MAX, ZOOM_MIN, ZOOM_MAX,
			ZOOM_MIN, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
			0.5f));
    ...
    {
	Animation ani = new AlphaAnimation(0.2f, 1f);//透明度设置
